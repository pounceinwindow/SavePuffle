namespace GravityFalls.Shared
{
    ...
    public static class BoardConfig
    {
        ...
        public static readonly int[] WaddlesSpawnCellsByDice = new[] { 6, 9, 13, 17, 23, 27 };
        ...
        public static int GetWaddlesSpawnCell(int dice)
        {
            if (dice < 1) dice = 1;
            if (dice > 6) dice = 6;
            return WaddlesSpawnCellsByDice[dice - 1];
        }
    }
}
